...
const EngCertificate = ({inn, serialId, numberId, isActive, setIsActive}) => {
    ...
    <a href={`https://ibank2.cbk.kg/minzdrav/get-pdf-file?pin=${inn}&seriaId=${serialId}&nomerId=${numberId}`}
      download>
           ...
           <div>
            ...
            <Button style={{textDecoration: 'underline #fecc00', marginLeft: 10}} size="small"  variant="contained"
               color="neutral" onClick={() => setIsActive(false) }> Отмена </Button>
            </div>
           </ThemeProvider>
    </a>
</div>: null } 
